...
const menuItems: MenuItem[] = [
  { id: "regular-bhature", name: "Regular Bhaature Chole", category: "Breakfast Specials", description: "2 bhaature with hearty chole", price: 50, image: categoryImages["Breakfast Specials"], popular: true },
  { id: "ghee-bhature", name: "Desi Ghee Bhaature Chole", category: "Breakfast Specials", description: "2 bhaature, chole & pure desi ghee", price: 70, image: categoryImages["Breakfast Specials"], tag: "Classic" },
  { id: "amritsari-bhature", name: "Amritsari Special Bhaature Chole", category: "Breakfast Specials", description: "2 large bhaature, chole & salad", price: 80, image: categoryImages["Breakfast Specials"], tag: "Special", popular: true },
  { id: "paneer-bhaatura", name: "Paneer Bhaatura Chole", category: "Breakfast Specials", description: "Paneer-stuffed bhaatura with chole", price: 90, image: categoryImages["Breakfast Specials"], tag: "Special" },
  { id: "extra-bhaatura", name: "Extra Bhaatura", category: "Breakfast Specials", description: "One fluffy piece, made to order", price: 20, image: categoryImages["Breakfast Specials"], note: "Per piece" },
  ...
  { id: "spring-roll", name: "Spring Roll", category: "Evening Snacks", description: "Crisp vegetable spring rolls", price: 50, image: categoryImages["Evening Snacks"], note: "3 pieces per plate" },
  { id: "paneer-spring-roll", name: "Paneer Spring Roll", category: "Evening Snacks", description: "Paneer-filled spring rolls", price: 70, image: categoryImages["Evening Snacks"], note: "3 pieces per plate" },
  { id: "regular-jalebi", name: "Regular Jalebi", category: "Jalebi Specials", description: "Fresh, crisp and syrupy", price: 40, image: jalebiImage, note: "100 gm", popular: true },
  { id: "kesar-jalebi", name: "Kesar Jalebi", category: "Jalebi Specials", description: "Saffron-kissed jalebi, made fresh", price: 50, image: jalebiImage, note: "100 gm", tag: "Special" },
  { id: "jalebi-rabri", name: "Jalebi with Rabri", category: "Jalebi Specials", description: "100 gm jalebi with creamy rabri", price: 80, image: jalebiImage, tag: "Popular" },
  { id: "extra-rabri", name: "Extra Rabri", category: "Jalebi Specials", description: "A small serving of creamy rabri", price: 30, image: jalebiImage, note: "Small serving" },
  { id: "amul-cup", name: "Amul Cup", category: "Amul Ice Creams", description: "Cold, creamy and ready to scoop", price: 30, image: categoryImages["Amul Ice Creams"], note: "125 ml" },
  { id: "amul-tub", name: "Amul Tub", category: "Amul Ice Creams", description: "A little more of your favourite", price: 40, image: categoryImages["Amul Ice Creams"], note: "125 ml" },
  { id: "amul-tricone", name: "Amul Tricone", category: "Amul Ice Creams", description: "Cone, chocolate and ice cream", price: 50, image: categoryImages["Amul Ice Creams"] },
  { id: "amul-bricks", name: "Amul Bricks", category: "Amul Ice Creams", description: "Take home a creamy classic", price: 120, image: categoryImages["Amul Ice Creams"], note: "500 ml" },
  { id: "amul-sundae", name: "Amul Special Sundae", category: "Amul Ice Creams", description: "A layered little celebration", price: 110, image: categoryImages["Amul Ice Creams"], tag: "Special", popular: true },
  { id: "ice-cream-scoop", name: "Ice Cream Scoop", category: "Amul Ice Creams", description: "One generous scoop of your choice", price: 70, image: categoryImages["Amul Ice Creams"], note: "Per scoop" },
  { id: "hot-chocolate", name: "Hot Chocolate", category: "Amul Desserts & Beverages", description: "Warm cocoa made with real milk", price: 90, image: categoryImages["Amul Desserts & Beverages"], popular: true },
  { id: "chocolate-brownie", name: "Chocolate Brownie", category: "Amul Desserts & Beverages", description: "Soft, fudgy and chocolate-rich", price: 100, image: categoryImages["Amul Desserts & Beverages"], popular: true },
  { id: "brownie-ice-cream", name: "Brownie with Ice Cream", category: "Amul Desserts & Beverages", description: "Warm brownie with a cold scoop", price: 150, image: categoryImages["Amul Desserts & Beverages"], tag: "Popular" },
  { id: "jalebi-rabri-dessert", name: "Jalebi Rabri", category: "Amul Desserts & Beverages", description: "Crisp jalebi with creamy rabri", price: 80, image: jalebiImage },
  { id: "amul-taaza", name: "Amul Taaza / Milk", category: "Amul Dairy Products", description: "Everyday dairy, subject to availability", price: null, image: categoryImages["Amul Dairy Products"], note: "MRP" },
  { id: "amul-butter", name: "Amul Butter", category: "Amul Dairy Products", description: "Subject to availability", price: null, image: categoryImages["Amul Dairy Products"], note: "MRP" },
  { id: "amul-cheese", name: "Amul Cheese", category: "Amul Dairy Products", description: "Subject to availability", price: null, image: categoryImages["Amul Dairy Products"], note: "MRP" },
  { id: "amul-paneer", name: "Amul Paneer", category: "Amul Dairy Products", description: "Subject to availability", price: null, image: categoryImages["Amul Dairy Products"], note: "MRP" },
  { id: "amul-curd", name: "Amul Curd / Dahi", category: "Amul Dairy Products", description: "Subject to availability", price: null, image: categoryImages["Amul Dairy Products"], note: "MRP" },
  { id: "other-amul", name: "Other Amul Products", category: "Amul Dairy Products", description: "Subject to availability", price: null, image: categoryImages["Amul Dairy Products"], note: "MRP" },
];
  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section className="specials-strip"><div className="section-intro"><span className="eyebrow">COUNTER FAVOURITES</span><h2>Start with<br /><i>something good.</i></h2><p>A few easy wins for hungry afternoons and sweet evenings.</p><button className="text-action" onClick={() => jumpToMenu("Shakes")}>See all picks <ArrowRight size={16} /></button></div><div className="feature-card feature-card--dark"><div className="feature-card__image"><img src={shakeImage} alt="Oreo shake" /></div><div className="feature-card__copy"><span className="feature-card__tag">MOST ORDERED</span><h3>Oreo Shake</h3><p>Cookie crumble, cream & chocolate.</p><div><b>₹139</b><button className="circle-arrow" onClick={() => addToCart(menuItems.find((item) => item.id === "oreo-shake")!)}><Plus size={18} /></button></div></div></div><div className="feature-card feature-card--saffron"><div className="feature-card__image"><img src={jalebiImage} alt="Kesar jalebi" /></div><div className="feature-card__copy"><span className="feature-card__tag">FRESH TODAY</span><h3>Jalebi with Rabri</h3><p>Golden spirals, creamy rabri.</p><div><b>₹80</b><button className="circle-arrow circle-arrow--dark" onClick={() => addToCart(menuItems.find((item) => item.id === "jalebi-rabri")!)}><Plus size={18} /></button></div></div></div></section>
        ...
        <section className="menu-section" id="menu"><div className="section-heading-row"><div><span className="eyebrow">THE FULL MENU</span><h2>Pick your<br /><i>kind of happy.</i></h2></div><div className="menu-heading-note"><Leaf size={18} /><span>Everything here is<br /><b>100% vegetarian.</b></span></div></div>
          ...
          <div className="item-grid">{filteredItems.map((item, index) => { const quantity = cart.find((line) => line.id === item.id)?.quantity ?? 0; return <>{index === 4 && <div className="editorial-card"><span className="eyebrow">THE SWEET SIDE</span><h3>Leave room<br /><i>for dessert.</i></h3><p>Jalebi, rabri, real-milk shakes and a little extra joy.</p><button onClick={() => { setActiveCategory("Jalebi Specials"); window.setTimeout(() => document.getElementById("menu")?.scrollIntoView({ behavior: "smooth" }), 0); }}>See sweet picks <ArrowRight size={14} /></button></div>}<ItemCard key={item.id} item={item} quantity={quantity} onAdd={() => addToCart(item)} onIncrease={() => updateCart(item, 1)} onDecrease={() => updateCart(item, -1)} onOpen={() => setSelectedItem(item)} /></>; })}</div>
